...
# ActivityLineChart (`ActivityLineChart.tsx`)
...
Path in repo: `components/system-admin/ActivityLineChart.tsx`. Together, these exports and any side effects at import time define how the rest of the project interacts with `ActivityLineChart.tsx`.
...
- **@/data/system-admin-store** (`type { ActivityPoint, ActivityPointDetail }`) – project module.
