...
# InspectorBottomNav (`InspectorBottomNav.tsx`)
...
Path in repo: `components/inspector/InspectorBottomNav.tsx`. Together, these exports and any side effects at import time define how the rest of the project interacts with `InspectorBottomNav.tsx`.
