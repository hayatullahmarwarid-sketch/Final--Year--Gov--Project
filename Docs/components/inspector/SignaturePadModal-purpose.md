...
# SignaturePadModal (`SignaturePadModal.tsx`)
...
Path in repo: `components/inspector/SignaturePadModal.tsx`. Together, these exports and any side effects at import time define how the rest of the project interacts with `SignaturePadModal.tsx`.
