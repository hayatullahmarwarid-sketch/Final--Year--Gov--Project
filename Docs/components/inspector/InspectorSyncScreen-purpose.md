...
# InspectorSyncScreen (`InspectorSyncScreen.tsx`)
...
Path in repo: `components/inspector/InspectorSyncScreen.tsx`. Together, these exports and any side effects at import time define how the rest of the project interacts with `InspectorSyncScreen.tsx`.
...
- **@/lib/inspector-offline-local-queue** (`{ loadLocalOfflineSubmits, removeLocalOfflineSubmitsByIds }`) – shared library code.
