...
# ExamAttemptReviewSheet (`ExamAttemptReviewSheet.tsx`)
...
Path in repo: `components/inspector-admin/ExamAttemptReviewSheet.tsx`. Together, these exports and any side effects at import time define how the rest of the project interacts with `ExamAttemptReviewSheet.tsx`.
...
- **@/data/inspector-admin-store** (`type { ExamAttemptAnswer, ExamResult }`) – project module.
