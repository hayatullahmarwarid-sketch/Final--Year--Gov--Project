...
# LiveImplementationMap (`LiveImplementationMap.tsx`)
...
Path in repo: `components/inspector-admin/LiveImplementationMap.tsx`. Together, these exports and any side effects at import time define how the rest of the project interacts with `LiveImplementationMap.tsx`.
