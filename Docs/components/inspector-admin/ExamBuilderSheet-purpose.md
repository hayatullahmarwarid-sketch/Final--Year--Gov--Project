...
# ExamBuilderSheet (`ExamBuilderSheet.tsx`)
...
Path in repo: `components/inspector-admin/ExamBuilderSheet.tsx`. Together, these exports and any side effects at import time define how the rest of the project interacts with `ExamBuilderSheet.tsx`.
...
- **@/data/inspector-admin-store** (`type { Exam, Question }`) – project module.
