...
# RegionalComplianceMap (`RegionalComplianceMap.tsx`)
...
Path in repo: `components/inspector-admin/RegionalComplianceMap.tsx`. Together, these exports and any side effects at import time define how the rest of the project interacts with `RegionalComplianceMap.tsx`.
...
- **@/data/inspector-admin-store** (`type { Incident }`) – project module.
