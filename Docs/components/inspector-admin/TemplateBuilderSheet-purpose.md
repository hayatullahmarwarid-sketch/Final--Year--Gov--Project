...
# TemplateBuilderSheet (`TemplateBuilderSheet.tsx`)
...
Path in repo: `components/inspector-admin/TemplateBuilderSheet.tsx`. Together, these exports and any side effects at import time define how the rest of the project interacts with `TemplateBuilderSheet.tsx`.
...
- **@/data/inspector-admin-store** (`type { Template, TemplateField }`) – project module.
...
4. Network calls request or mutate remote data; results update UI state or context.
