...
# DashboardActivityChart (`DashboardActivityChart.tsx`)
...
Path in repo: `components/inspector-admin/DashboardActivityChart.tsx`. Together, these exports and any side effects at import time define how the rest of the project interacts with `DashboardActivityChart.tsx`.
