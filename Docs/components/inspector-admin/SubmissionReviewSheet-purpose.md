...
# SubmissionReviewSheet (`SubmissionReviewSheet.tsx`)
...
Path in repo: `components/inspector-admin/SubmissionReviewSheet.tsx`. Together, these exports and any side effects at import time define how the rest of the project interacts with `SubmissionReviewSheet.tsx`.
...
- **@/components/inspector-admin/InspectorSignaturePreview** (`{ InspectorSignaturePreview }`) – UI component.
