...
# ExamScoreRing (`ExamScoreRing.tsx`)
...
Path in repo: `components/exam/ExamScoreRing.tsx`. Together, these exports and any side effects at import time define how the rest of the project interacts with `ExamScoreRing.tsx`.
