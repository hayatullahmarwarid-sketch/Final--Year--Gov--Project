...
# LanguageOptionCard (`LanguageOptionCard.tsx`)
...
Path in repo: `components/language/LanguageOptionCard.tsx`. Together, these exports and any side effects at import time define how the rest of the project interacts with `LanguageOptionCard.tsx`.
