...
# Decrees Activity Helpers (`decrees-activity-helpers.ts`)
...
Path in repo: `components/dept-upload/decrees-activity-helpers.ts`. Together, these exports and any side effects at import time define how the rest of the project interacts with `decrees-activity-helpers.ts`.
