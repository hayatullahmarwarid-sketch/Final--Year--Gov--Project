...
# DeptUploadRecentActivityCard (`DeptUploadRecentActivityCard.tsx`)
...
Path in repo: `components/dept-upload/DeptUploadRecentActivityCard.tsx`. Together, these exports and any side effects at import time define how the rest of the project interacts with `DeptUploadRecentActivityCard.tsx`.
...
- **@/components/dept-upload/ActivityDetailsModal** (`{ ActivityDetailsModal, type ActivityDetailsPayload }`) – UI component.
