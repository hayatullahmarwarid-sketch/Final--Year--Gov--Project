...
# DeptUploadMostViewedCard (`DeptUploadMostViewedCard.tsx`)
...
Path in repo: `components/dept-upload/DeptUploadMostViewedCard.tsx`. Together, these exports and any side effects at import time define how the rest of the project interacts with `DeptUploadMostViewedCard.tsx`.
