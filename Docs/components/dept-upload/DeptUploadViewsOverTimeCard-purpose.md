...
# DeptUploadViewsOverTimeCard (`DeptUploadViewsOverTimeCard.tsx`)
...
Path in repo: `components/dept-upload/DeptUploadViewsOverTimeCard.tsx`. Together, these exports and any side effects at import time define how the rest of the project interacts with `DeptUploadViewsOverTimeCard.tsx`.
...
- **@/components/dept-upload/MonthlyStatsModal** (`type { MonthlyStatsDetail }`) – UI component.
