...
# DeptUploadSettingsNotificationsTab (`DeptUploadSettingsNotificationsTab.tsx`)
...
Path in repo: `components/dept-upload/DeptUploadSettingsNotificationsTab.tsx`. Together, these exports and any side effects at import time define how the rest of the project interacts with `DeptUploadSettingsNotificationsTab.tsx`.
...
- **@/lib/api/devices** (`{ registerExpoDeviceToken, unregisterDevice }`) – app API and data access helper.
