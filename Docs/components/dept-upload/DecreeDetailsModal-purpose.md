...
# DecreeDetailsModal (`DecreeDetailsModal.tsx`)
...
Path in repo: `components/dept-upload/DecreeDetailsModal.tsx`. Together, these exports and any side effects at import time define how the rest of the project interacts with `DecreeDetailsModal.tsx`.
