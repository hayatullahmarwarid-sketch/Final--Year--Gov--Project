...
Path in repo: `components/ui/icon-symbol.tsx`. Together, these exports and any side effects at import time define how the rest of the project interacts with `icon-symbol.tsx`.
