...
# InMemoryLruCacheProvider (`InMemoryLruCacheProvider.js`)
...
Path in repo: `back-end/src/services/cache/InMemoryLruCacheProvider.js`. Together, these exports and any side effects at import time define how the rest of the project interacts with `InMemoryLruCacheProvider.js`.

## Libraries used

- **lru-cache** – third-party dependency for this module.
