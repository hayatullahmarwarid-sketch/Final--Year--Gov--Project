...
# System Admin Dashboard Serializer (`system-admin-dashboard.serializer.js`)
...
Path in repo: `back-end/src/modules/system-admin/serializers/system-admin-dashboard.serializer.js`. Together, these exports and any side effects at import time define how the rest of the project interacts with `system-admin-dashboard.serializer.js`.
