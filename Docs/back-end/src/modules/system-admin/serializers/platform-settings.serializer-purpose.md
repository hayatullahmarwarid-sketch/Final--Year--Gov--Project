...
# Platform Settings Serializer (`platform-settings.serializer.js`)
...
Path in repo: `back-end/src/modules/system-admin/serializers/platform-settings.serializer.js`. Together, these exports and any side effects at import time define how the rest of the project interacts with `platform-settings.serializer.js`.
