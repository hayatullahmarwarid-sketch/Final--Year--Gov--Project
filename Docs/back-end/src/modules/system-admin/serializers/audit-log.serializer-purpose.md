...
# Audit Log Serializer (`audit-log.serializer.js`)
...
Path in repo: `back-end/src/modules/system-admin/serializers/audit-log.serializer.js`. Together, these exports and any side effects at import time define how the rest of the project interacts with `audit-log.serializer.js`.
