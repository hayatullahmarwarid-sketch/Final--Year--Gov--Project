...
# Inspection Evidence Serializer (`inspection-evidence.serializer.js`)
...
Path in repo: `back-end/src/modules/inspectors/serializers/inspection-evidence.serializer.js`. Together, these exports and any side effects at import time define how the rest of the project interacts with `inspection-evidence.serializer.js`.
