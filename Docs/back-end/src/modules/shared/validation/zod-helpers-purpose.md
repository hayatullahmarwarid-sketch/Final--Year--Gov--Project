...
Path in repo: `back-end/src/modules/shared/validation/zod-helpers.js`. Together, these exports and any side effects at import time define how the rest of the project interacts with `zod-helpers.js`.
