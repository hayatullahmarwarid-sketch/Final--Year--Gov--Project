...
# Query Filters (`query-filters.js`)
...
Path in repo: `back-end/src/modules/shared/constants/query-filters.js`. Together, these exports and any side effects at import time define how the rest of the project interacts with `query-filters.js`.
