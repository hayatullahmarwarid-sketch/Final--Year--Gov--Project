...
# Stored File Purpose (`stored-file-purpose.js`)
...
Path in repo: `back-end/src/modules/shared/constants/stored-file-purpose.js`. Together, these exports and any side effects at import time define how the rest of the project interacts with `stored-file-purpose.js`.
