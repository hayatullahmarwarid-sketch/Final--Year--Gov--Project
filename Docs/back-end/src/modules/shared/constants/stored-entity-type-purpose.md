...
# Stored Entity Type (`stored-entity-type.js`)
...
Path in repo: `back-end/src/modules/shared/constants/stored-entity-type.js`. Together, these exports and any side effects at import time define how the rest of the project interacts with `stored-entity-type.js`.
