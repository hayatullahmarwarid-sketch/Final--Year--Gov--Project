...
# Cache Control (`cache-control.js`)
...
Path in repo: `back-end/src/modules/shared/http/cache-control.js`. Together, these exports and any side effects at import time define how the rest of the project interacts with `cache-control.js`.
