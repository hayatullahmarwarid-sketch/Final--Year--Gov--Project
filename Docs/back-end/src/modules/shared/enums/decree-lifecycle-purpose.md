...
# Decree Lifecycle (`decree-lifecycle.js`)
...
Path in repo: `back-end/src/modules/shared/enums/decree-lifecycle.js`. Together, these exports and any side effects at import time define how the rest of the project interacts with `decree-lifecycle.js`.
