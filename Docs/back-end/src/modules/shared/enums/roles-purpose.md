...
Path in repo: `back-end/src/modules/shared/enums/roles.js`. Together, these exports and any side effects at import time define how the rest of the project interacts with `roles.js`.
