...
# Certificate Kind (`certificate-kind.js`)
...
Path in repo: `back-end/src/modules/shared/enums/certificate-kind.js`. Together, these exports and any side effects at import time define how the rest of the project interacts with `certificate-kind.js`.
