...
# Notification Channel (`notification-channel.js`)
...
Path in repo: `back-end/src/modules/shared/enums/notification-channel.js`. Together, these exports and any side effects at import time define how the rest of the project interacts with `notification-channel.js`.
