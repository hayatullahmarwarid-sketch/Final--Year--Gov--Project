...
# Static Page Status (`static-page-status.js`)
...
Path in repo: `back-end/src/modules/shared/enums/static-page-status.js`. Together, these exports and any side effects at import time define how the rest of the project interacts with `static-page-status.js`.
