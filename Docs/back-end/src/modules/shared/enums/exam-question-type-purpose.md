...
# Exam Question Type (`exam-question-type.js`)
...
Path in repo: `back-end/src/modules/shared/enums/exam-question-type.js`. Together, these exports and any side effects at import time define how the rest of the project interacts with `exam-question-type.js`.
