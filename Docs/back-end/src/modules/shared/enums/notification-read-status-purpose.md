...
# Notification Read Status (`notification-read-status.js`)
...
Path in repo: `back-end/src/modules/shared/enums/notification-read-status.js`. Together, these exports and any side effects at import time define how the rest of the project interacts with `notification-read-status.js`.
