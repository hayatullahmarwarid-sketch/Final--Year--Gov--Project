...
# Exam Attempt Status (`exam-attempt-status.js`)
...
Path in repo: `back-end/src/modules/shared/enums/exam-attempt-status.js`. Together, these exports and any side effects at import time define how the rest of the project interacts with `exam-attempt-status.js`.
