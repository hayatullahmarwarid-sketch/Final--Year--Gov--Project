...
# Certificate Status (`certificate-status.js`)
...
Path in repo: `back-end/src/modules/shared/enums/certificate-status.js`. Together, these exports and any side effects at import time define how the rest of the project interacts with `certificate-status.js`.
