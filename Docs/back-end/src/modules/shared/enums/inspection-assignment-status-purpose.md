...
# Inspection Assignment Status (`inspection-assignment-status.js`)
...
Path in repo: `back-end/src/modules/shared/enums/inspection-assignment-status.js`. Together, these exports and any side effects at import time define how the rest of the project interacts with `inspection-assignment-status.js`.
