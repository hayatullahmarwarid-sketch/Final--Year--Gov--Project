...
# User Account Status (`user-account-status.js`)
...
Path in repo: `back-end/src/modules/shared/enums/user-account-status.js`. Together, these exports and any side effects at import time define how the rest of the project interacts with `user-account-status.js`.
