...
# Decree Version Publication (`decree-version-publication.js`)
...
Path in repo: `back-end/src/modules/shared/enums/decree-version-publication.js`. Together, these exports and any side effects at import time define how the rest of the project interacts with `decree-version-publication.js`.
