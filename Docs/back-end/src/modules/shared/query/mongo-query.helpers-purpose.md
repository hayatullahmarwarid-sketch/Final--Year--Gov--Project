...
# Mongo Query Helpers (`mongo-query.helpers.js`)
...
Path in repo: `back-end/src/modules/shared/query/mongo-query.helpers.js`. Together, these exports and any side effects at import time define how the rest of the project interacts with `mongo-query.helpers.js`.
