...
# Mongoose List (`mongoose-list.js`)
...
Path in repo: `back-end/src/modules/shared/data/mongoose-list.js`. Together, these exports and any side effects at import time define how the rest of the project interacts with `mongoose-list.js`.
