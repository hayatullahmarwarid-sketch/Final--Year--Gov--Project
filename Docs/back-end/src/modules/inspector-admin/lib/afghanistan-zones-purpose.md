...
# Afghanistan Zones (`afghanistan-zones.js`)
...
Path in repo: `back-end/src/modules/inspector-admin/lib/afghanistan-zones.js`. Together, these exports and any side effects at import time define how the rest of the project interacts with `afghanistan-zones.js`.
