...
# Inspector Admin Routes (`inspector-admin.routes.js`)
...
Path in repo: `back-end/src/modules/inspector-admin/inspector-admin.routes.js`. Together, these exports and any side effects at import time define how the rest of the project interacts with `inspector-admin.routes.js`.
...
- **./inspector-admin.controller.js** (`{ inspectorAdminController }`) – relative project import.
