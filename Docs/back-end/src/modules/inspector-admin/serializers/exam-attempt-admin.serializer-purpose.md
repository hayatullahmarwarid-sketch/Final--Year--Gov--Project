...
# Exam Attempt Admin Serializer (`exam-attempt-admin.serializer.js`)
...
Path in repo: `back-end/src/modules/inspector-admin/serializers/exam-attempt-admin.serializer.js`. Together, these exports and any side effects at import time define how the rest of the project interacts with `exam-attempt-admin.serializer.js`.
