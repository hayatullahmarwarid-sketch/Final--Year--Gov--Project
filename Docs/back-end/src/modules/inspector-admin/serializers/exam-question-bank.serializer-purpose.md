...
# Exam Question Bank Serializer (`exam-question-bank.serializer.js`)
...
Path in repo: `back-end/src/modules/inspector-admin/serializers/exam-question-bank.serializer.js`. Together, these exports and any side effects at import time define how the rest of the project interacts with `exam-question-bank.serializer.js`.
