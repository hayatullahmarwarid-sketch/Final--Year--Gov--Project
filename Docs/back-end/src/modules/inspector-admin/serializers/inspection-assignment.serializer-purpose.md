...
# Inspection Assignment Serializer (`inspection-assignment.serializer.js`)
...
Path in repo: `back-end/src/modules/inspector-admin/serializers/inspection-assignment.serializer.js`. Together, these exports and any side effects at import time define how the rest of the project interacts with `inspection-assignment.serializer.js`.
