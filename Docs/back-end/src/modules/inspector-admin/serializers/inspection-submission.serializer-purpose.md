...
# Inspection Submission Serializer (`inspection-submission.serializer.js`)
...
Path in repo: `back-end/src/modules/inspector-admin/serializers/inspection-submission.serializer.js`. Together, these exports and any side effects at import time define how the rest of the project interacts with `inspection-submission.serializer.js`.
