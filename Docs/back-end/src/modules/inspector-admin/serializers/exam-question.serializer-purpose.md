...
# Exam Question Serializer (`exam-question.serializer.js`)
...
Path in repo: `back-end/src/modules/inspector-admin/serializers/exam-question.serializer.js`. Together, these exports and any side effects at import time define how the rest of the project interacts with `exam-question.serializer.js`.
