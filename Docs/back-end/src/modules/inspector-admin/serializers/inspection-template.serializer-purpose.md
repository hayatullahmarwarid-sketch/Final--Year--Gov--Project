...
# Inspection Template Serializer (`inspection-template.serializer.js`)
...
Path in repo: `back-end/src/modules/inspector-admin/serializers/inspection-template.serializer.js`. Together, these exports and any side effects at import time define how the rest of the project interacts with `inspection-template.serializer.js`.
