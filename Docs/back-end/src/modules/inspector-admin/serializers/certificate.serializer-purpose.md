...
# Certificate Serializer (`certificate.serializer.js`)
...
Path in repo: `back-end/src/modules/inspector-admin/serializers/certificate.serializer.js`. Together, these exports and any side effects at import time define how the rest of the project interacts with `certificate.serializer.js`.
