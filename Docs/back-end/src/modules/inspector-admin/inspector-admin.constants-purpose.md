...
# Inspector Admin Constants (`inspector-admin.constants.js`)
...
Path in repo: `back-end/src/modules/inspector-admin/inspector-admin.constants.js`. Together, these exports and any side effects at import time define how the rest of the project interacts with `inspector-admin.constants.js`.
