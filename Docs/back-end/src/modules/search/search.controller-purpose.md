...
Path in repo: `back-end/src/modules/search/search.controller.js`. Together, these exports and any side effects at import time define how the rest of the project interacts with `search.controller.js`.

## Libraries used

- **../shared/http/index.js** (`{ asyncHandler, sendSuccess }`) – relative project import.
- **./search.service.js** (`{ searchService }`) – relative project import.
