...
# Inspection Answer Rules (`inspection-answer.rules.js`)
...
Path in repo: `back-end/src/modules/inspections/inspection-answer.rules.js`. Together, these exports and any side effects at import time define how the rest of the project interacts with `inspection-answer.rules.js`.
