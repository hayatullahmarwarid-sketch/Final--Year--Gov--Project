...
# Inspection Submission Review Workflow (`inspection-submission-review.workflow.js`)
...
Path in repo: `back-end/src/modules/inspections/inspection-submission-review.workflow.js`. Together, these exports and any side effects at import time define how the rest of the project interacts with `inspection-submission-review.workflow.js`.
...
- **../shared/http/index.js** (`{ ConflictError, NotFoundError }`) – relative project import.
