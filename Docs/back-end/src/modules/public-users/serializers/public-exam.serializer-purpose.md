...
# Public Exam Serializer (`public-exam.serializer.js`)
...
Path in repo: `back-end/src/modules/public-users/serializers/public-exam.serializer.js`. Together, these exports and any side effects at import time define how the rest of the project interacts with `public-exam.serializer.js`.
