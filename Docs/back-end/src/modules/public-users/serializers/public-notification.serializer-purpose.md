...
# Public Notification Serializer (`public-notification.serializer.js`)
...
Path in repo: `back-end/src/modules/public-users/serializers/public-notification.serializer.js`. Together, these exports and any side effects at import time define how the rest of the project interacts with `public-notification.serializer.js`.
