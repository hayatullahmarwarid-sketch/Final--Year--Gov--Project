...
# Public Exam Question Serializer (`public-exam-question.serializer.js`)
...
Path in repo: `back-end/src/modules/public-users/serializers/public-exam-question.serializer.js`. Together, these exports and any side effects at import time define how the rest of the project interacts with `public-exam-question.serializer.js`.
