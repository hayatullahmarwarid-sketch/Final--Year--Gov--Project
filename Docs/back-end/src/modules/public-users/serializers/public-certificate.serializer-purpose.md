...
# Public Certificate Serializer (`public-certificate.serializer.js`)
...
Path in repo: `back-end/src/modules/public-users/serializers/public-certificate.serializer.js`. Together, these exports and any side effects at import time define how the rest of the project interacts with `public-certificate.serializer.js`.
