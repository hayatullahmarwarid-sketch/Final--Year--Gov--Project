...
# Public Decree Category Serializer (`public-decree-category.serializer.js`)
...
Path in repo: `back-end/src/modules/public-users/serializers/public-decree-category.serializer.js`. Together, these exports and any side effects at import time define how the rest of the project interacts with `public-decree-category.serializer.js`.
