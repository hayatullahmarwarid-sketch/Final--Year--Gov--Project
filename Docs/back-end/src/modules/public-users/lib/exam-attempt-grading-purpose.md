...
# Exam Attempt Grading (`exam-attempt-grading.js`)
...
Path in repo: `back-end/src/modules/public-users/lib/exam-attempt-grading.js`. Together, these exports and any side effects at import time define how the rest of the project interacts with `exam-attempt-grading.js`.
