...
# Resolve Public User Identity (`resolve-public-user-identity.js`)
...
Path in repo: `back-end/src/modules/public-users/lib/resolve-public-user-identity.js`. Together, these exports and any side effects at import time define how the rest of the project interacts with `resolve-public-user-identity.js`.
