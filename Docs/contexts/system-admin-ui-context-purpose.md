...
# System Admin Ui Context (`system-admin-ui-context.tsx`)
...
Path in repo: `contexts/system-admin-ui-context.tsx`. Together, these exports and any side effects at import time define how the rest of the project interacts with `system-admin-ui-context.tsx`.
