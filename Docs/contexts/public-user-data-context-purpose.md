...
# Public User Data Context (`public-user-data-context.tsx`)
...
Path in repo: `contexts/public-user-data-context.tsx`. Together, these exports and any side effects at import time define how the rest of the project interacts with `public-user-data-context.tsx`.
...
- **@/lib/user-scoped-storage-keys** (`{ publicUserDataStorageKey }`) – shared library code.
