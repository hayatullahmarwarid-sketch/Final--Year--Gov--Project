...
# System Admin Remote Context (`system-admin-remote-context.tsx`)
...
Path in repo: `contexts/system-admin-remote-context.tsx`. Together, these exports and any side effects at import time define how the rest of the project interacts with `system-admin-remote-context.tsx`.
...
- **@/lib/system-admin-mapper** (`{ auditRowToEntry, roleBreakdownToTotals, staffMemberToStaffUser }`) – shared library code.
