...
# Use Clear Sensitive On Web Restore (`use-clear-sensitive-on-web-restore.ts`)
...
Path in repo: `hooks/use-clear-sensitive-on-web-restore.ts`. Together, these exports and any side effects at import time define how the rest of the project interacts with `use-clear-sensitive-on-web-restore.ts`.
