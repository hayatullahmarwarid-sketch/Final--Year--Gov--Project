...
- `export { FormColors } from '@/lib/theme';`

Path in repo: `constants/form.ts`. Together, these exports and any side effects at import time define how the rest of the project interacts with `form.ts`.
