...
# Decree Category Styles (`decree-category-styles.ts`)
...
Path in repo: `constants/decree-category-styles.ts`. Together, these exports and any side effects at import time define how the rest of the project interacts with `decree-category-styles.ts`.
