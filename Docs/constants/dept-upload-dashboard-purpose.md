...
# Dept Upload Dashboard (`dept-upload-dashboard.ts`)
...
Path in repo: `constants/dept-upload-dashboard.ts`. Together, these exports and any side effects at import time define how the rest of the project interacts with `dept-upload-dashboard.ts`.
