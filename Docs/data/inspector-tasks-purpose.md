...
# Inspector Tasks (`inspector-tasks.ts`)
...
Path in repo: `data/inspector-tasks.ts`. Together, these exports and any side effects at import time define how the rest of the project interacts with `inspector-tasks.ts`.
