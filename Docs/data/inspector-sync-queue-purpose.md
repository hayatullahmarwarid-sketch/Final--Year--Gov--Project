...
# Inspector Sync Queue (`inspector-sync-queue.ts`)
...
Path in repo: `data/inspector-sync-queue.ts`. Together, these exports and any side effects at import time define how the rest of the project interacts with `inspector-sync-queue.ts`.
