...
# Afghanistan Regions (`afghanistan-regions.ts`)
...
Path in repo: `data/afghanistan-regions.ts`. Together, these exports and any side effects at import time define how the rest of the project interacts with `afghanistan-regions.ts`.
