...
# Public Catalog (`public-catalog.ts`)
...
Path in repo: `lib/api/public-catalog.ts`. Together, these exports and any side effects at import time define how the rest of the project interacts with `public-catalog.ts`.
