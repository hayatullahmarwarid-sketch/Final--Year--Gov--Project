...
# Inspector Admin (`inspector-admin.ts`)
...
Path in repo: `lib/api/inspector-admin.ts`. Together, these exports and any side effects at import time define how the rest of the project interacts with `inspector-admin.ts`.
