...
# Certificates Public (`certificates-public.ts`)
...
Path in repo: `lib/api/certificates-public.ts`. Together, these exports and any side effects at import time define how the rest of the project interacts with `certificates-public.ts`.
