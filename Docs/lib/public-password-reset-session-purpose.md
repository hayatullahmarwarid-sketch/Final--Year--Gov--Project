...
# Public Password Reset Session (`public-password-reset-session.ts`)
...
Path in repo: `lib/public-password-reset-session.ts`. Together, these exports and any side effects at import time define how the rest of the project interacts with `public-password-reset-session.ts`.
