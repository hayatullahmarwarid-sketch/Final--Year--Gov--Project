...
Path in repo: `lib/adapters/toast.ts`. Together, these exports and any side effects at import time define how the rest of the project interacts with `toast.ts`.
