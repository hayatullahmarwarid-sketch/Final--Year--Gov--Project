...
Path in repo: `lib/adapters/storage.ts`. Together, these exports and any side effects at import time define how the rest of the project interacts with `storage.ts`.
