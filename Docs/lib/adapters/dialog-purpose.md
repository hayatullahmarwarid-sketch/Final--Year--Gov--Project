...
Path in repo: `lib/adapters/dialog.ts`. Together, these exports and any side effects at import time define how the rest of the project interacts with `dialog.ts`.
