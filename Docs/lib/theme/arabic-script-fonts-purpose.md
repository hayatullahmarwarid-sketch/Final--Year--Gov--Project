...
# Arabic Script Fonts (`arabic-script-fonts.ts`)
...
Path in repo: `lib/theme/arabic-script-fonts.ts`. Together, these exports and any side effects at import time define how the rest of the project interacts with `arabic-script-fonts.ts`.
