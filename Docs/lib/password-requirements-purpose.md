...
# Password Requirements (`password-requirements.ts`)
...
Path in repo: `lib/password-requirements.ts`. Together, these exports and any side effects at import time define how the rest of the project interacts with `password-requirements.ts`.
