...
# Public Register Fields (`public-register-fields.ts`)
...
Path in repo: `lib/validation/public-register-fields.ts`. Together, these exports and any side effects at import time define how the rest of the project interacts with `public-register-fields.ts`.
