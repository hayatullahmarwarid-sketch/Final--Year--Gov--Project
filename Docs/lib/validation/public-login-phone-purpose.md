...
# Public Login Phone (`public-login-phone.ts`)
...
Path in repo: `lib/validation/public-login-phone.ts`. Together, these exports and any side effects at import time define how the rest of the project interacts with `public-login-phone.ts`.
