...
Path in repo: `lib/validation/password-policy.ts`. Together, these exports and any side effects at import time define how the rest of the project interacts with `password-policy.ts`.
