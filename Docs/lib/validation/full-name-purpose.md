...
Path in repo: `lib/validation/full-name.ts`. Together, these exports and any side effects at import time define how the rest of the project interacts with `full-name.ts`.
