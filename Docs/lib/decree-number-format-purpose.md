...
# Decree Number Format (`decree-number-format.ts`)
...
Path in repo: `lib/decree-number-format.ts`. Together, these exports and any side effects at import time define how the rest of the project interacts with `decree-number-format.ts`.
