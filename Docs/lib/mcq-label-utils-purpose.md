...
# Mcq Label Utils (`mcq-label-utils.ts`)
...
Path in repo: `lib/mcq-label-utils.ts`. Together, these exports and any side effects at import time define how the rest of the project interacts with `mcq-label-utils.ts`.
