...
Path in repo: `lib/auth-routing.ts`. Together, these exports and any side effects at import time define how the rest of the project interacts with `auth-routing.ts`.
