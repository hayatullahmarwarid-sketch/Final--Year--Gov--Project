...
# Exam Api Questions (`exam-api-questions.ts`)
...
Path in repo: `lib/public/exam-api-questions.ts`. Together, these exports and any side effects at import time define how the rest of the project interacts with `exam-api-questions.ts`.

## Libraries used

- **@/data/exam-content** (`type { ExamQuestion }`) – project module.
