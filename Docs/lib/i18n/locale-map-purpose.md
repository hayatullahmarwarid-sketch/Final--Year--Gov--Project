...
Path in repo: `lib/i18n/locale-map.ts`. Together, these exports and any side effects at import time define how the rest of the project interacts with `locale-map.ts`.
