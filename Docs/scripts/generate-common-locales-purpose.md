...
# Generate Common Locales (`generate-common-locales.mjs`)
...
Path in repo: `scripts/generate-common-locales.mjs`. Together, these exports and any side effects at import time define how the rest of the project interacts with `generate-common-locales.mjs`.
...
- **./i18n-ui-extra.mjs** (`{ UI_EXTRA }`) – relative project import.
- **./i18n-ui-more.mjs** (`{ UI_MORE }`) – relative project import.
