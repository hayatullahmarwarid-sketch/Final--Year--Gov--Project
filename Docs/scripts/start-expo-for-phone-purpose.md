...
# Start Expo For Phone (`start-expo-for-phone.mjs`)
...
Path in repo: `scripts/start-expo-for-phone.mjs`. Together, these exports and any side effects at import time define how the rest of the project interacts with `start-expo-for-phone.mjs`.

## Libraries used

- **node:child_process** – third-party dependency for this module.
