...
# Strip Web Platform Branches (`strip-web-platform-branches.mjs`)
...
Path in repo: `scripts/strip-web-platform-branches.mjs`. Together, these exports and any side effects at import time define how the rest of the project interacts with `strip-web-platform-branches.mjs`.

## Libraries used

- **fs** – third-party dependency for this module.
