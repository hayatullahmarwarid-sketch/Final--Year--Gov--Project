...
# Strip Web Haptic Guards (`strip-web-haptic-guards.mjs`)
...
Path in repo: `scripts/strip-web-haptic-guards.mjs`. Together, these exports and any side effects at import time define how the rest of the project interacts with `strip-web-haptic-guards.mjs`.
