...
# Normalize Purpose Docs (`normalize-purpose-docs.mjs`)
...
Path in repo: `scripts/normalize-purpose-docs.mjs`. Together, these exports and any side effects at import time define how the rest of the project interacts with `normalize-purpose-docs.mjs`.
